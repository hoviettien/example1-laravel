        ...
        @foreach ($slide as $sl)
            <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                ...
                <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                    ...
                    src="{{ asset('/source/image/slide/'.$sl->image) }}" data-src="{{ asset('/source/image/slide/'.$sl->image) }}"
                    style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url({{ asset('/source/image/slide/'.$sl->image) }}); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                    </div>
                </div>
            </li>
        @endforeach  
